"""Regression checks for the axiom-rel-breaker-probe casebook."""
...
from casebook.harness import assert_expected, axiom_rel_breaker_probe_summary
...
class CasebookTests(unittest.TestCase):
    ...
    def test_named_summary_alias(self) -> None:
        self.assertEqual(axiom_rel_breaker_probe_summary(), assert_expected())
